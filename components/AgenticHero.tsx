...
const AgenticHero: React.FC = () => {
    ...
    return (
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        <button 
                            ...
                            className="w-full sm:w-auto bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white px-10 py-5 rounded-2xl font-bold uppercase text-sm tracking-widest transition-all shadow-[0_0_30px_rgba(6,182,212,0.3)] hover:scale-105"
                        >
                            Get a Demo
                        </button>
            ...
            <DemoFormModal isOpen={showDemoForm} onClose={() => setShowDemoForm(false)} />
        </>
    );
};
